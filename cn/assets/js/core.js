function createSVGEl(e) {
  ...
  return (
    e
      ? (t.setAttributeNS(null, "viewBox", e.viewBox),
        t.setAttributeNS(null, "preserveAspectRatio", e.preserveAspectRatio))
      : t.setAttributeNS(null, "viewBox", "0 0 100 100"),
...
function draw(e, t) {
  ...
  (n = pathDefs.checkmark),
    (a = animDefs.checkmark),
    i.push(document.createElementNS("http://www.w3.org/2000/svg", "path"));
  for (var r = 0, l = i.length; r < l; ++r) {
    ...
    (s.style.strokeDasharray = c + " " + c),
      ...
      (s.style.transition = s.style.WebkitTransition = s.style.MozTransition =
        "stroke-dashoffset " +
        a.speed +
        "s " +
        a.easing +
...
function reset(e) {
  Array.prototype.slice
    .call(e.parentNode.querySelectorAll("svg > path"))
    .forEach(function(e) {
...
if (
  ...
  $(document).ready(function() {
    if ($("#znav-container").length) {
      ...
      ($this = $("#znav-container")),
        ...
        $("#znav-container #navbarNavDropdown ul.navbar-nav .megamenu").each(
          function() {
  ...
  $(document).ready(function() {
    if (!$("[class^=gsap-]").length && $(".parallax").length)
      new Rellax(".parallax", { center: !1 });
  }),
  $(document).ready(function() {
  ...
  $(document).ready(function() {
    if ($(".flexslider").length) {
      var e = function(e) {
        0 != $(e).find("*[data-zanim-timeline]").length &&
          $(e)
    ...
    Array.prototype.forEach.call(a, function(e) {
      ...
      e.addEventListener("change", function(e) {
        ...
        (a =
          ...
          ? (t.querySelector("span").innerHTML = a)
          : (t.innerHTML = n);
      }),
  ...
  var checkbxsCheckmark = Array.prototype.slice.call(
    document.querySelectorAll('.zinput.zcheckbox input[type="checkbox"]')
  );
...
$(document).ready(function() {
  ...
  $(document).ready(function() {
    $(".ui.dropdown").length && $(".ui.dropdown").dropdown(),
      $(".ui.accordion").length &&
        $(".ui.accordion").accordion({ exclusive: !1 });
  }),
  $(document).ready(function() {
    ...
    $(".sortable").length &&
      $(".sortable").each(function() {
        ...
        t.isotope({
          ...
          masonry: { columnWidth: ".sortable-item" }
        }),
