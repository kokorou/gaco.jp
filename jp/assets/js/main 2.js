function getIOSVersion(e) {
  return (
    ...
    parseFloat(
      (
        "" +
        (/CPU.*OS ([0-9_]{1,5})|(CPU like).*AppleWebKit.*Mobile/i.exec(e) || [
          0,
          ""
        ])[1]
      )
...
function smoothScroll() {
  var e = $(window);
  e.on("mousewheel DOMMouseScroll", function(i) {
    i.preventDefault();
    var o = i.originalEvent.wheelDelta / 120 || -i.originalEvent.detail / 3,
...
$(document).ready(function() {
  var e =
    ...
    r = (n || e) && !!window.CSS;
  e && $("html").addClass("opera"),
    i && $("html").addClass("firefox"),
    o && $("html").addClass("safari"),
    a && $("html").addClass("ie"),
    t && $("html").addClass("edge"),
    n && $("html").addClass("chrome"),
    r && $("html").addClass("blink");
}),
  $(document).ready(function() {
    is_EDGE ||
